<script lang="ts">
    import { classnames } from '$lib/daisyUiComponents/util.js';
    ...
    $: classes = classnames(`inline mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600`, className, {
